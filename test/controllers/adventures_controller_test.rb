...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { end: @adventure.end, name: @adventure.name, photo_album_id: @adventure.photo_album_id, post_id: @adventure.post_id, start: @adventure.start }
    end
  ...
  test "should update adventure" do
    patch :update, id: @adventure, adventure: { end: @adventure.end, name: @adventure.name, photo_album_id: @adventure.photo_album_id, post_id: @adventure.post_id, start: @adventure.start }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
